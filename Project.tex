...
This algorithm ignores a lot of information that is available such as capacity, group sizes, etc. and due to its effective na\"{i}vety I expect that it will give inferior performance to the ETA and ETD algorithms presented in sections \ref{algETAdescription} and \ref{algETDdescription}.  However, it is considerably less computationally expensive than all of the variations of ETA and ETD.  Due to its attempt to minimise time wasted during car movement conflicts, it may demonstrate competition with the na\"{i}ve ETA and ETD variants.
